...
describe('getToday', () => {
    ...
    test('getToday', () => {
        mockDate('2020-01-02T12:00:00z')//YEAR-MONTH-DAY
...
test('getURL', () => {
    ...
    expect(url).toBe('https://olinda.bcb.gov.br/olinda/servico/PTAX/versao/v1/odata/CotacaoDolarDia(dataCotacao=@dataCotacao)?@dataCotacao=%27MINHA-DATA%27&$top=100&$format=json&$select=cotacaoCompra,cotacaoVenda')
})
